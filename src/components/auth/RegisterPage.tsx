...
const RegisterPage: React.FC<RegisterPageProps> = ({ onToggleMode }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Welcome to CustomerConnect!",
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-100 via-white to-teal-100 dark:from-purple-900/20 dark:via-background dark:to-teal-900/20 p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center fade-in">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Join CustomerConnect</h1>
        ...
        <Card className="glass-card hover-lift">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Enter your information to create your CustomerConnect account
            </CardDescription>
          </CardHeader>
